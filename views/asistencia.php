...
if (!isset($_SESSION['rol'])) {
    echo "<script>alert('⚠️ Acceso denegado. Inicia sesión primero.'); window.location.href='../login.php';</script>";
    exit();
}

// Si el rol no tiene permiso
if ($_SESSION['rol'] === 'apoyo territorial') {
    echo "<script>alert('🚫 No tienes permiso para acceder a este módulo'); window.location.href = '../controlador/modulos.php';</script>";
    exit();
}
